    ...
    <div class="row">
      <div class="col-md-12">
        <div class="app-title">
          ...
          <div id="clock"><span class="date"> Thứ Hai, 13/03/2023 - 22 giờ 25 phút 21 giây</span></div>
        </div>
      </div>
    </div>
        <div class="row">
            ...
            <div class="col-md-6">
                <div class="tile">
                    ...
                    <div class="embed-responsive embed-responsive-16by9">
                        <canvas class="embed-responsive-item" id="lineChartDemo" width="408" height="230" style="width: 408px; height: 230px;"></canvas>
                    </div>
                </div>
            </div>
            <div class="col-md-6">
                <div class="tile">
                    ...
                    <div class="embed-responsive embed-responsive-16by9">
                        <canvas class="embed-responsive-item" id="barChartDemo" width="408" height="230" style="width: 408px; height: 230px;"></canvas>
                    </div>
                </div>
            </div>
        </div>
