<template>
  ...
  <main class="app-content">
    <div class="app-title">
      ...
      <div id="clock">
        <span class="date"> Thứ Hai, 13/03/2023 - 21 giờ 54 phút 12 giây</span>
      </div>
    </div>
    <div class="row">
      <div class="col-md-12">
            ...
            <div class="row element-button">
              <div class="col-sm-2">
                <a
                  ...
                  title="Thêm"
                  ><font-awesome-icon icon="fa-solid fa-plus" /> Tạo mới nhân viên</a
                >
              </div>
              <div class="col-sm-2">
                <a
...
<script>
import TheNav from "@/admin/TheNav.vue";
export default {
  name: "TheStaff",
  components: {
    TheNav,
